...
def _validate_phase9_boundary(failures: list[str]) -> dict[str, int]:
    ...
    if stage9.get("status") != "stage9_29_closed_version_bound":
        failures.append("roadmap execution memory must record Stage 9 as stage9_29_closed_version_bound")
    ...
    if substage_status.get("9.29") != "complete_stage9_closed_version_bound":
        failures.append("Stage 9.29 must be marked complete_stage9_closed_version_bound")
