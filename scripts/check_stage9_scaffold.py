...
def check_stage9_scaffold(root: Path = ROOT) -> dict[str, object]:
    ...
    if stage9_27_started:
        ...
        if checklist.exists():
            ...
            for phrase in ["Main manuscript source | ready", "Supplementary Information source | ready", "Editor-triage note | ready", "Editorial pitch | ready", "Software-reporting checklist | ready", "Reporting Summary | registered", "final Springer Nature form remains a human submission action"]:
                if phrase not in body:
