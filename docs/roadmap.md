...
query for author review while preserving the no-contact boundary, and Stage
...
manuscript closure is complete, Stage 10.19 no-send closeout is complete, and
Stage 10.20 EIC/manuscript strengthening is complete. Stage 10.0 through Stage
10.20 are closed for the current evidence-elevation chain. The next
