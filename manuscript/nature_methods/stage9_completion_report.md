...
- Closure commit. `5ad1a1f325057e8049e28fbe92dfbd50db627f70`.
...
- Reference version. `reference-library@2026-07-04@42be37d69bc6b0229aa611f260215454db4e3f12`.
- Package version. `stage9.29-closure@5ad1a1f325057e8049e28fbe92dfbd50db627f70`.
...
|---|---:|---:|
| `manuscript/nature_methods/submission_package/main_text_for_submission.md` | `c9f288d89d71` | `35938` |
| `manuscript/nature_methods/submission_package/supplementary_information_for_submission.md` | `d5bf3eadafa0` | `11912` |
| `manuscript/nature_methods/submission_package/submission_manifest.md` | `8c121a456983` | `2195` |
...
| `manuscript/nature_methods/submission_package/package_consistency_audit.md` | `1d55cc484144` | `1679` |
| `manuscript/nature_methods/submission_package/figure_file_inventory.csv` | `e5230d7be7fb` | `4121` |
| `manuscript/nature_methods/submission_package/source_data_and_statistics_inventory.csv` | `de736e886ee2` | `6267` |
| `manuscript/nature_methods/submission_package/references_for_submission.bib` | `eaf20b336015` | `6503` |
| `manuscript/nature_methods/submission_package/reporting_summary_REQUIRED.md` | `b83b8d2f639e` | `1448` |
| `manuscript/nature_methods/submission_package/submission_package_manifest.json` | `4b7abc566a86` | `4822` |
...
| `manuscript/nature_methods/submission_package/pi_review_revision_log.md` | `40f1b06f6869` | `1639` |
| `manuscript/nature_methods/submission_package/pi_review_literature_calibration.md` | `b03493ece6c5` | `1493` |
