...
- Assembly source commit. `39a692f9934305be111642c812a1fbdd44b17262`.
...
- Package version. `stage9.29-closure@39a692f9934305be111642c812a1fbdd44b17262`.
...
| `manuscript/nature_methods/submission_package/submission_manifest.md` | `7168175350c4` | `5613` |
| `manuscript/nature_methods/submission_package/submission_readiness_checklist.md` | `c5b30ec255ca` | `5475` |
...
| `manuscript/nature_methods/submission_package/final_upload_runbook_AUTHOR_CONFIRMATION_REQUIRED.md` | `cef5eb3dcbc2` | `4386` |
| `manuscript/nature_methods/submission_package/prior_art_positioning_matrix.md` | `148544f738b5` | `5933` |
| `manuscript/nature_methods/submission_package/validation_breadth_and_boundary_map.md` | `97a9a95f46f5` | `4902` |
| `manuscript/nature_methods/submission_package/editor_objection_response_map.md` | `96928659e456` | `5133` |
| `manuscript/nature_methods/submission_package/editor_two_minute_triage_simulation.md` | `f4d982dc3402` | `4073` |
| `manuscript/nature_methods/submission_package/nature_methods_editorial_bar_rescue_audit.md` | `1e77f9c5f7f1` | `22357` |
| `manuscript/nature_methods/submission_package/current_nature_methods_policy_preflight.md` | `a4ae36393348` | `5127` |
| `manuscript/nature_methods/submission_package/reviewer_editor_fit_planner_AUTHOR_CONFIRMATION_REQUIRED.md` | `1c65dcaac72a` | `6401` |
...
| `manuscript/nature_methods/submission_package/package_consistency_audit.md` | `30bfc9ad0882` | `4552` |
...
| `manuscript/nature_methods/submission_package/submission_package_manifest.json` | `b27c015aeee0` | `11008` |
...
| `manuscript/nature_methods/submission_package/pi_review_literature_calibration.md` | `11dbd0872428` | `1534` |
