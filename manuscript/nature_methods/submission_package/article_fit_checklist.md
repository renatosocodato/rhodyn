...
| Abstract length | 150 words | Nature Methods Article limit is up to 150 words and unreferenced. | pass |
| Main text length | 1976 words | Nature Methods Article target is 3,000 words, with up to 5,000 words at editorial discretion, excluding abstract, Methods, references, and figure legends. | pass |
| Main display items | 6 figures | Nature Methods Article limit is up to six main figures and/or tables. | pass |
| Reference count | 14 references | Nature Methods Article guidance typically recommends up to 50 references. | pass |
...
| Results subheadings | present | Nature Methods permits topical Results subheadings. | pass |
| Methods subheadings | present | Nature Methods permits topical Online Methods subheadings. | pass |
| Discussion subheadings | absent | Nature Methods Article Discussion does not contain subheadings. | pass |
